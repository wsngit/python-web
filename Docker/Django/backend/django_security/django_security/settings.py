...
SECRET_KEY = 'django-insecure-@)j-xc3#^=a&^^3)a_j)i*84yrub9mpvyp%j3w%vjcjxw17a=b'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://django:djangopass@postgres:5432/djangodb',
        conn_max_age=600
    )
}
